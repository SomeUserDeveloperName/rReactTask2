...
const TrEditNotesTable = ({events, note}) => {
    ...
    return (
            <ul className="noteRow"> 
                ...
                <li name="noteName"><input type="text" name="noteName" maxlength="50" value={localNote.name} onChange={(e, field = `name`) => handleChange}/></li>
                <li name="noteCategory">{categoriesSelector(notesCategories, note.category)}</li>
                <li name="noteContent"><input type="text" name="noteContent" maxlength="50" value={localNote.content} onChange={(e, field = `content`) => handleChange}/></li>
